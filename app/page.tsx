      ...
      >
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-7">
            {[
              ["01", "Choose your role", "Select the role you are preparing for."],
              ["02", "Take the interview", "Answer dynamic questions generated by AI."],
              ["03", "Understand your performance", "Receive a detailed AI-powered report."],
              ["04", "Build your roadmap", "Follow personalized recommendations to improve."],
